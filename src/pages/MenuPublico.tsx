...
export default function MenuPublicoPage() {
  ...
  const handleOrderConfirmed = async (clienteId: string | null) => {
    ...
    try {
      // A lógica de ocupação da mesa já foi tratada no modal.
      // Aqui, apenas adicionamos o item ao pedido que agora deve existir.

      // 1. Encontra o pedido aberto para a mesa
      ...
      if (pedidoAberto) {
        ...
        // Se mesmo após a ocupação o pedido não existir (caso raro), criamos um.
      ...
      // Invalida os dados da mesa para refletir a nova ocupação na UI
